import { PlayerBattleState, Skill } from "../../recoil/battle";

export const calcSingleDamage = (attacker: PlayerBattleState, defender: PlayerBattleState, skill: Skill) => {
...
export const calcBarrier = (actor: PlayerBattleState, skill: Skill) => {
